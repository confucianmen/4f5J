...
var hanValue = [1,2,3,4,5,6,7,8,9,12,24,36];
    ...
    var extensionMethods = {
        ...
        pips: function( settings ) {
            ...
            slider.element.on( "mouseup", ".ui-slider-label", function() {
                labelClick( this );
                //console.log($(".ui-slider-handle").find(".ui-slider-tip").text());
                var va = $("#hanzi-labels-slider .ui-slider-pip-selected").find(".ui-slider-label").text();
                var vat = $("#hanzi-labels-slider .ui-slider-pip-selected").find(".ui-slider-label").attr("data-value");
                rechargeInfo.time = vat;
                console.log(rechargeInfo.time );

                if(parseInt( rechargeInfo.time) < 9){
                    rechargeInfo.price = (parseInt(rechargeInfo.time) + 1)  * rechargeInfo.flowPrice * rechargeInfo.totalFlow;
                }
                else if(parseInt( rechargeInfo.time) == 9){
                    rechargeInfo.price = 12 * rechargeInfo.flowPrice  * rechargeInfo.totalFlow * 0.85;
                }
                else if(parseInt( rechargeInfo.time) == 10){
                    rechargeInfo.price = 24 * rechargeInfo.flowPrice  * rechargeInfo.totalFlow * 0.85;
                }
                else if(parseInt( rechargeInfo.time) == 11){
                    rechargeInfo.price = 36 * rechargeInfo.flowPrice  * rechargeInfo.totalFlow * 0.85;
                }

                $(".recharge-choosen-detail .time").text(va >=2 && va <= 9 ? va + "个月" : va);
